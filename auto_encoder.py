...
def get_similar_room_example(pic_path = r"data/dataset/7480.jpg"):
    with open("data/lsh.pkl", "rb") as fh:
        ...
        for ele in res:
            ...
            img_list.append(data_id)
        show_similar_images(img_list)

def show_similar_images(list):
    for i in range(10):
        im = Image.open("./data/images/" + str(list[i])+ ".jpg")
        im.show()


if __name__ == '__main__':
    # get_train_img_data() #读取图Wx`片数据
    # print("Finish loading img data")
